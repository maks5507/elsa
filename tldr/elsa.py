...
class Elsa:
    ...
    def summarize(self, text: str, factor: float, **abstractive_params) -> str:
        ...
        filtered_sentences_scores = self.extractive.summarize(filtered_preprocessed_sentences, factor)
